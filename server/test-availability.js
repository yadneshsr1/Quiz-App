...
const token =
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiI2OGIwODlhOGViOGQwNzA3MDJhYjA3MDgiLCJyb2xlIjoic3R1ZGVudCIsImlhdCI6MTc1Njg3NTAyMSwiZXhwIjoxNzU2OTYxNDIxfQ.IYv4vGzK7zCqyFJbjHAUaQ4bTjmP94Gcc2Tz7SH0Zmw";
        ...
        .forEach((quiz, index) => {
          ...
          if (quiz.reasons.submissionOk.submissionDetails) {
            ...
            console.log(
              `   Submitted: ${new Date(
                sub.submittedAt
              ).toLocaleString()}, Score: ${sub.score}%`
            );
          }
        });
    } catch (error) {
